...
#define NETSNMP_CONFIGURE_OPTIONS " '--prefix=/usr' '--libdir=/usr/lib' '--mandir=/usr/share/man' '--disable-nls' '--enable-shared' '--host=aarch64-solaris2.11' '--with-endianness=little' '--with-defaults' '--with-sys-contact=Unknown' '--with-sysconfdir=/etc/net-snmp' '--without-perl-modules' '--disable-embedded-perl' 'host_alias=aarch64-solaris2.11' 'CC=/data/illumos-gate/usr/src/cross/bin/aarch64-solaris2.11-gcc  -Wl,--no-relax --sysroot=/data/proto/root_aarch64 -isystem /data/proto/root_aarch64/usr/include' 'CFLAGS=  -I/data/proto/root_aarch64/usr/sfw/include -fno-strict-aliasing -Wno-unused-variable' 'LDFLAGS= -Wl,--no-relax --sysroot=/data/proto/root_aarch64 -L/data/proto/root_aarch64/usr/sfw/lib -Wl,-rpath,/usr/sfw/lib ' 'LIBS= -lkstat -lnsl -lsocket -lgen -lscf -lresolv -lbsm'"
